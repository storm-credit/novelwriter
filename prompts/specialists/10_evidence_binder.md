...
**당신의 승인 없이는 어떤 이슈도 서사 균형 원칙 위반 판정에 사용될 수 없습니다.**
...
**합격 + 합격**: evidence_quality = "strong" → 서사 균형 원칙 판정에 사용 가능
...
- 예: "따라서 이 씬에서 에반이 대가 없이 소환에 성공했다면 소환의 무게 원칙 위반일 가능성이 높음"
...
4. **confidence ≥ 0.8 이상의 서사 균형 원칙 이슈에는 evidence가 최소 2개 필요**
