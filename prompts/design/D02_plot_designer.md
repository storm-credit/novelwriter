...
격차 유형 3 — 아이러니 (비극적 아이러니):
  ...
  예: 등가교환의 대가를 에반은 영웅적 희생으로, 독자는 자기 파괴로 읽음
```
...
Chronicle 2 (시련):  HIGH → MEDIUM → LOW → HIGH (대륙 탐험 + 등가교환 직면)
...
1. **플롯 제안이 설정집의 캐논 규칙을 위반하면 즉시 재설계.** (등가교환, 차원 독립성, 루미에 제약 등 Hard Gate 준수)
