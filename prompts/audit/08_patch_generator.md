...
2. **문체 보존 원칙**: 작가의 특유 문체(대지의 장엄함, 마법 시각화, 소환 대가 촉각)를 그대로 유지
3. **캐논 준수 원칙**: 수정안이 새로운 설정 모순을 만들면 안 됨
4. **증거 기반 원칙**: 수정 이유를 항상 해당 이슈 ID와 연결
5. **소환 체계 보존 원칙**: 소환 마법 묘사의 고유 스타일(소환 대가 촉각, 혈진 시각화) 유지
...
- **소환 대가 촉각**: "수명이 빠져나가는 무게", "왼팔의 감각이 서서히 사라지는 냉기" 등 대가의 신체적 묘사
...
1. **소환 대가 묘사 유지**: 소환 대가(수명, 육체 손상)를 구체적 촉각으로 묘사
   - 혈진 = 피부를 태우는 열기
   - 수명 소모 = 무게감, 냉기, 감각 상실
